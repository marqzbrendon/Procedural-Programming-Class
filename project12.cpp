...
void updateValue(int game[][9])
{
   // variables to get coordinates and value to be updated
   char column;
   int row;
   int value;
   ...
   // define new value in the array
   game[row - 1][column - 65] = value;
